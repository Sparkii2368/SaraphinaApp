...
# ------------------ Local fallback ------------------
def local_save():
    if vectorizer and retriever and X:
...
def retrieve(query: str, recall_depth: int):
    if not (retriever and vectorizer and X and memory_docs):
        return []
...
with st.form("teach_form"):
    ...
    if submitted and teach_text_input.strip():
        ...
        teach_text(teach_text_input, teach_label, tags, teach_source, recall